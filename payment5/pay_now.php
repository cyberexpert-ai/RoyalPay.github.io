...
$qr_code_url = "https://liteqr.xyz/v1/qr?size=300x300&data=" . urlencode($orders);
...
<body>
 ...
 <form id="paymentForm" action="https://khilaadixpro.shop/instantpay/googlepay/payment-verify" method="post">
    <!-- Other input fields -->
...
function upiCountdown(elm, minute, second, url) {
    ...
    function startTimer() {
        ...
        if(m < 0){
            ...
            window.location.href = "https://khilaadixpro.shop";
        }
