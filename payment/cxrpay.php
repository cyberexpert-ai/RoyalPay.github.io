...
// Set cURL options
curl_setopt($ch, CURLOPT_URL, 'https://khilaadixpro.shop/HDFCSoft/upiverify');
...
if ($responseArray['status']==="Success"){
    ...
    // Endpoint URL
$url = 'https://khilaadixpro.shop/HDFCSoft/upicollect';
$params = array(
...
if ($stmt->execute()) {
    ...
    header("Location: https://khilaadixpro.shop/payment/instant-pay/confirm/$link_token");
    ...
    window.onload = function() {
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                window.location.href = "https://khilaadixpro.shop/payment/instant-pay/'.$link_token.'"; // Redirect to instant-pay with link token
            }
        });
    }
</script>';
